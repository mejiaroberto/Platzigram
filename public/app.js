...
var template = yo`<nav class="header">
	...
	<div class="container">
	<div class="row">
	<div class="col s12 m6 offset-m10">
...
},{"../landing":20,"yo-yo":8}],23:[function(require,module,exports){
var page = require('page');
var empty = require('empty-element');
var template = require('./template');
var title = require('title');
...
var signupForm = yo`<div class="col s12 m7">
						 ...
						 <div class="sigup-box">
						 	<h1 class="platzigram">Platzigram</h1>
							 <form class="signup-form">
							   <h2>Registrate para ver las fotos de tus amigos estudiando en Platzi</h2>
							    <div class="section">
							    	<a class="btn btn-fb hide-on-small-only">Iniciar sesión con Facebook</a>
							    	<a class="btn btn-fb hide-on-med-and-up"><i class="fa fa-facebook-official"></i>Iniciar sesión</a>
							    </div>
